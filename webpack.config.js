...
module.exports = {
  ...
  entry: {
    main: './src/frontend/homepage/index.js',
    collectionsScript: './src/frontend/collection/collections.js',
    newrecipe: "./src/frontend/newrecipe/newrecipe.js",
    recipeScript: "./src/frontend/newrecipe/newrecipe.js",
    profile:"./src/frontend/profile/profile.js",
  }, 
  ...
  plugins: [ 
    //new HtmlWebpackPlugin({template: './src/frontend/index.html', filename: path.resolve(__dirname, 'views') + '/index.html'}) ,
